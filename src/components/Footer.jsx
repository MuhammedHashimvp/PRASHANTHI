      ...
      <Container fluid className="pt-5">
        <div className="first-div">
          <Row className="element-container text-white">
            ...
            >
              <div className="logo-footer px-5">
                <img
                  src={footerlogo}
                  alt="Prashanthi Ayurveda Hospital Logo"
                  className="img-fluid"
                />
              </div>
            </Col>
            ...
            <Col
              xs={12}
              md={4}
              className="text-center text-md-start mb-4 mb-md-0 text-dark"
            >
            ...
            <Col xs={12} md={4}>
              <div className="remove-overflow d-flex flex-wrap justify-content-center justify-content-md-start footer-links">
                <div className=" remove-overflow d-flex w-100 justify-content-center justify-content-md-start gap-3 mb-2 ">
                  <Link  to={"/"}>Home</Link>
                    {/* <a className="text-dark">Services</a> */}
                </div>
          ...
          <Row className=" justify-content-center text-white mt-4 mb-1">
            <Col xs="auto">
              <a
                href="https://facebook.com/prashanthiayurvedakondotty"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://instagram.com/prashanthiayurveda"
                target="_blank"
                rel="noreferrer"
                className="social-icon"
              >
        ...
        <Row className="element-footer text-center">
          <Col>
            <h6 className="mb-0 remove-overflow mt-2">
              © 2025 prashanthiayurveda.com All rights reserved.
            </h6>
          </Col>
        </Row>
      </Container>
